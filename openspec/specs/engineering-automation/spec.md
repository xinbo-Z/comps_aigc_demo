...
定义统一代码规范、提交规范和自动化校验工作流，包括 ESLint、Prettier、Husky、lint-staged、commitlint 和 cz-git。

## Requirements

### Requirement: 仓库级代码规范与格式规范 SHALL 统一
...
### Requirement: Git hooks SHALL 对暂存文件执行提交前校验
...
### Requirement: 工程自动化与工作区脚本体系 SHALL 集成
